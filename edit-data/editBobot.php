<?php
include 'koneksi.php';
$dataedit = mysqli_query($koneksi, "SELECT * from bobot where idbobot='" . $_GET['idbobot'] . "'");
                    ...
                    <fieldset class="form-group border p-3">
                        ...
                        <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="idbobot" value="<?php echo $result['idbobot'] ?>">
                                </div>
                                </div>    
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="idkriteria" value="<?php echo $result['nmalternatif'] ?>">
                                </div>
                                </div>    
