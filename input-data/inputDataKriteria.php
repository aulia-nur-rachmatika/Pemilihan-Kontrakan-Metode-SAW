    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 form-1-box wow fadeInUp">
                ...
                <form action="aksi_input_kriteria.php" method="post">
                    ...
                    <fieldset class="form-group border p-3">
                        ...
                        <div class="form-group">
                            <label for="nmkriteria">ID Kriteria:</label>
                            <input type="text" class="form-control username" id="nmkriteria" placeholder="ID Kriteria" name="idkriteria">
                        </div>

                        <div class="form-group">
                            <label for="nmkriteria">Nama Kriteria:</label>
                            <input type="text" class="form-control username" id="nmkriteria" placeholder="Kriteria" name="nmkriteria">
                        </div>
