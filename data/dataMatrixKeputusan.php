        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#">Data Matrix Keputusan</a>
              </li>
...
<br>
   ...
   <legend  class="w-auto">Data Matrix Keputusan</legend>
   <br>
<div class="mx-auto w-75" >
   <a href="inputDataMatrix.php" class="link-success">Tambah Data</a>
</div>
